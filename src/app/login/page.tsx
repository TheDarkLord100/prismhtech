  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#FFFDEB] px-4">
      <div className="relative w-full max-w-md rounded-2xl bg-[#FFFDEB] p-10 shadow-[0_0_25px_5px_rgba(168,85,247,0.6)]">
        {/* Heading */}
        <h1 className="mb-8 text-3xl font-bold text-gray-900">Sign in</h1>
        ...
        <div className="mb-6 text-left">
          <a
            href="#"
            className="text-sm font-medium text-[#A855F7] hover:text-[#7E22CE]"
          >
            Forgot password ?
          </a>
        </div>
...
<div className="my-6 flex items-center">
  ...
  <span className="mx-3 text-sm text-gray-700 font-bold">or</span>
  <div className="h-[2px] flex-1 bg-gray-600"></div>
</div>
...
<div className="space-y-3">
  {/* Google */}
  <button className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#e0e0db] py-3 px-4 text-base font-medium text-gray-800 hover:bg-gray-300 transition">
