...
export default function ProductsPage() {
  ...
  const sortedProducts = useMemo(() => {
    ...
    return [...products].sort((a, b) =>
      sortType === "high-to-low" ? b.price - a.price : a.price - b.price
    );
  }, [products, sortType]);
  ...
  return (
    <div className="bg-gradient-to-r from-[#16463B] via-[#317A45] to-[#4CAF50]">
      ...
      <main className="flex min-h-screen flex-col items-center justify-start px-4 pt-24 pb-10">
        {/* Search Bar */}
        <div className="relative w-full max-w-md mb-14">
        ...
        {/* Header + Sort */}
        <div className="flex justify-between items-center mb-10 w-full max-w-7xl relative">
        ...
        {sortedProducts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-0 max-w-7xl w-full">
